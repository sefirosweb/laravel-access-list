            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        <Nav.Link as={NavLink} to={`/${APP_PREFIX}/view/users`} eventKey="1">{t('Users')}</Nav.Link>
                        <Nav.Link as={NavLink} to={`/${APP_PREFIX}/view/roles`} eventKey="2">{t('Roles')}</Nav.Link>
                        <Nav.Link as={NavLink} to={`/${APP_PREFIX}/view/access_list`} eventKey="3">{t('AccessList')}</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
